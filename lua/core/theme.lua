...
local function apply_highlights(c)
	...
	-- Lazy.nvim
	hi(0, "LazyNormal", { fg = c.on_surface, bg = c.surface_container })
	hi(0, "LazyH1", { fg = c.on_primary, bg = c.primary, bold = true })
	hi(0, "LazyH2", { fg = c.v_primary, bold = true })
	hi(0, "LazyButton", { fg = c.on_surface, bg = c.surface_container_high })
	hi(0, "LazyButtonActive", { fg = c.on_primary, bg = c.primary })
	hi(0, "LazySpecial", { fg = c.v_secondary })
	hi(0, "LazyComment", { fg = c.outline, italic = true })
	hi(0, "LazyProgressDone", { fg = c.v_primary })
	hi(0, "LazyProgressTodo", { fg = c.outline_variant })
end
